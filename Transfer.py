...
class Ui_TransferWindow(object):
    def setupUi(self, TransferWindow):
        ...
        TransferWindow.setStyleSheet("background-color: rgb(117, 130, 87);\n"
"")
...
"color: rgb(252, 55, 9);")
    ...
    def retranslateUi(self, TransferWindow):
        ...
        self.comboBox_bankType.setItemText(1, _translate("TransferWindow", "SBI"))
        self.comboBox_bankType.setItemText(2, _translate("TransferWindow", "Bank of Baroda"))
        self.comboBox_bankType.setItemText(3, _translate("TransferWindow", "ICICI Bank"))
        self.comboBox_bankType.setItemText(4, _translate("TransferWindow", "HDFC Bank"))
        self.comboBox_bankType.setItemText(5, _translate("TransferWindow", "Axis Bank"))
        self.comboBox_bankType.setItemText(6, _translate("TransferWindow", "Kotak mahindra"))
